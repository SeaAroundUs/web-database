...
AS WITH base_table(fishing_entity_id, year, sector_type_id, eez_id, effort_gear_id, length_code, m_um, motorisation, kw_boat, number_boats, days_fished, em_factor, sfr, fuel_coeff) AS (
