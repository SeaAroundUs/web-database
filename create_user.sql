...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_user WHERE usename = 'sau_reader' LIMIT 1) THEN
    CREATE USER sau_reader WITH PASSWORD 'sau_reader' NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT NOREPLICATION;
  END IF;
END
$$;
